...
public class UserRegistrationCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		/* set role student for new register user */
...
//System.out.println("-------------------"+request.getParameter("dob"));
		...
		System.out.println("UserRegistrationCtl Method populatebean Ended");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("UserRegistrationCtl Method doGet Started");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// get model UserModel model = new UserModel(); // long id =
		...
		if (OP_SIGN_UP.equalsIgnoreCase(op)) {
			...
			try {
				...
				bean.setId(pk); // request.getSession().setAttribute("UserBean", bean);
		...
		System.out.println("UserRegistrationCtl Method doPost Ended");
