...
public class ForgetPasswordCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println("ForgetPasswordCtl Method populatebean Ended");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("ForgetPasswordCtl Method doGet Started");
...
// get model
		...
		if (OP_GO.equalsIgnoreCase(op)) {
			try {
				...
				System.out.println("model ki forgetpsw method ko call kiya");
			...
			System.out.println("operation " + op + "  mila");
			System.out.println("FPCtl pr redirect kiya");
			ServletUtility.redirect(ORSView.FORGET_PASSWORD_CTL, request, response);
			return;
		}
		log.debug("ForgetPasswordCtl Method doPost Ended");
		System.out.println("ForgetPasswordCtl Method doPost Ended");
		ServletUtility.forward(getView(), request, response);
