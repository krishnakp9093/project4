...
public class RoleListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		System.out.println("RoloListCtl preload start");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("RoleListCtl doGet Start");
		List list = null;
...
//			 ServletUtility.setList(list, request);
		...
		System.out.println("RoleListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("RoleListCtl doPost Start");
		List list = null;
		...
		System.out.println("RoleListCtl doPost End");
	}
