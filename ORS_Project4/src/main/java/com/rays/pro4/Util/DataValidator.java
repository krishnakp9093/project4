...
public class DataValidator {
	...
	/*
	 * public static void main(String[] args) { System.out.println("Not Null  " +
	 * isNotNull("ABC")); System.out.println("Not Null  " + isNotNull(null));
	 * System.out.println("Not Null  " + isNull("123"));
	 * 
